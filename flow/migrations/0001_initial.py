    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_created=True, auto_now_add=True)),
                ('type', models.CharField(choices=[('NEXT', 'NEXT (Value represent Item)'), ('ERROR', 'Error (Value represent Exception)'), ('COMPLETE', 'COMPLETE (Value is none)'), ('UNKNOWN', 'UNKNOWN (Should never be used)')], default='UNKNOWN', max_length=1000)),
                ('t', models.IntegerField()),
